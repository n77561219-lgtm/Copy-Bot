...
- Эмодзи: 2-4 на весь пост, только там где усиливают смысл, не в каждом предложении
- Не используй буллет-списки если это не стиль автора
- Пост должен читаться легко, не монолитным блоком текста
"""
